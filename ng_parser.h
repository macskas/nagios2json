...
#define NG_PARSER_H
	...
	class NagiosParser
	{
		...
		private:
			...
			void add_hostcomment(std::string, nagios_comment_t*);
			void add_servicecomment(std::string, std::string, nagios_comment_t*);
			void add_hostdowntime(std::string, nagios_downtime_t*);
			void add_servicedowntime(std::string, std::string, nagios_downtime_t*);
